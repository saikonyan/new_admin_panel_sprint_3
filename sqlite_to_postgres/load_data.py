...
if __name__ == '__main__':
    ...
    dsl = {'dbname': os.environ.get('DBB_NAME'),
           'user': os.environ.get('DBB_USER'),
           'password': os.environ.get('DBB_PASSWORD'),
           'host': os.environ.get('DBB_HOST'),
           'port': os.environ.get('DBB_PORT')}
